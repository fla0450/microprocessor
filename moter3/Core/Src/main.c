  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  case SW_CCW:
		  ...
		  if(CCW_COUNTER > 5){CCW_COUNTER = 5;}
		  motor_ccr2 = 100*CCW_COUNTER;
	  ...
	  case SW_CW:
		  CCW_COUNTER = 0;
		  HAL_TIM_PWM_Start(&htim1, TIM_CHANNEL_2);
		  if(CW_COUNTER > 5){CW_COUNTER =10;}

		  motor_ccr2 = 100*CW_COUNTER;
